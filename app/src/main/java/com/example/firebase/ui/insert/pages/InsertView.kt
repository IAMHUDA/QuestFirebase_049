...
import com.example.firebase.ui.insert.viewmodel.FormErrorState
import com.example.firebase.ui.insert.viewmodel.FormState
import com.example.firebase.ui.insert.viewmodel.InsertUiState
import com.example.firebase.ui.insert.viewmodel.InsertViewModel
import com.example.firebase.ui.insert.viewmodel.MahasiswaEvent
...
fun FormMahasiswa(
    ...
    Column (
        ...
        OutlinedTextField(
            ...
            label = { Text("dospemdua") },
            isError = errorState.alamat != null,
            placeholder = { Text("Masukkan doepemdua") },
        )
        Text(
            text = errorState.alamat ?: "",
            color = Color.Red)
